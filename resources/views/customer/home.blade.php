                                                ...
                                                <div class="col-md-6 col-lg-4 col-xl-3">
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img ">
                                                            ...
                                                            {{-- <img style="height: 200px" src="{{asset('productImages/'.$item->image)}}" class=" w-100 rounded-top" alt=""> --}}
                                                        </div>
                                                        ...
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            ...
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                                <p class="text-dark fs-5 fw-bold mb-0">{{$item->price}} mmk/ 1pcs</p>
                            ...
                            <div class="position-relative">
                                ...
                                <div class="d-flex align-items-center flex-nowrap">
                                    <div class="bg-secondary rounded">
                                        ...
                                        <img src="{{asset('userProfile/'.$item->profile)}}" class="img-fluid rounded-circle p-3" style="width: 100px; height: 100px;" alt="">
                                       @else
