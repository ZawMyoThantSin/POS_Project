                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" value="{{old('name',$product->name)}}" class="form-control  @error('name') is-invalid @endError" id="exampleFormControlInput1" placeholder="Name...">
                                        @error('name')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="price" value="{{old('price',$product->price)}}" class="form-control @error('price') is-invalid @endError" id="exampleFormControlInput2" placeholder="Price...">
                                        @error('price')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="count" value="{{old('count',$product->count)}}" class="form-control @error('count') is-invalid @endError" id="exampleFormControlInput5" placeholder="Count...">
                                        @error('count')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
